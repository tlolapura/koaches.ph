...
I confirm that I am physically able to participate. I voluntarily assume all risks associated with training sessions organized by my coach through KoachesPH.

I release my coach, facility operators, and KoachesPH from liability for any injury, loss, or damage arising from my participation, except where caused by gross negligence or willful misconduct.
...
export function buildIntakeUrl(coachSlug: string, origin = "https://koaches.ph") {
